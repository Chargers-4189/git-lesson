...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      if (
        stocks.getCurrentStock("Google") >= StartHighGoogle && googleStock > 0
      ) {
        ...
        stocks.getCurrentStock("Google") <= StartLowGoogle &&
        bankAccount > stocks.getCurrentStock("Google") &&
        bankAccount > 1000
      ) {
        bankAccount -= stocks.getCurrentStock("Google");
      ...
      //Nvidia
      if (
        stocks.getCurrentStock("Nvidia") >= StartHighNvidia && nvidiaStock > 0
      ) {
        ...
        stocks.getCurrentStock("Nvidia") <= StartLowNvidia &&
        bankAccount > stocks.getCurrentStock("Nvidia") &&
        bankAccount > 1000
      ) {
        bankAccount -= stocks.getCurrentStock("Nvidia");
      ...
      //Coke
      if (
        stocks.getCurrentStock("Coke-Cola") >= StartHighCokeCola &&
        cokeStock > 0
      ) {
        ...
        stocks.getCurrentStock("Coke-Cola") <= StartLowCokeCola &&
        bankAccount > stocks.getCurrentStock("Coke-Cola") &&
        bankAccount > 1000
      ) {
        bankAccount -= stocks.getCurrentStock("Coke-Cola");
      ...
      //Lenovo
      if (
        stocks.getCurrentStock("Lenovo") >= StartHighLenovo && lenovoStock > 0
      ) {
        ...
        stocks.getCurrentStock("Lenovo") <= StartLowLenovo &&
        bankAccount > stocks.getCurrentStock("Lenovo") &&
        bankAccount > 1000
      ) {
        bankAccount -= stocks.getCurrentStock("Lenovo");
      ...
      //Honeywell
      if (
        stocks.getCurrentStock("Honeywell") >= StartHighHoneywell &&
        honeywellStock > 0
      ) {
        ...
        stocks.getCurrentStock("Honeywell") <= StartLowHoneywell &&
        bankAccount > stocks.getCurrentStock("Honeywell") &&
        bankAccount > 1000
      ) {
        bankAccount -= stocks.getCurrentStock("Honeywell");
      ...
      System.out.println(
        ...
        (
          honeywellStock *
          stocks.getCurrentStock("Honeywell") +
          lenovoStock *
          stocks.getCurrentStock("Lenovo") +
          googleStock *
          stocks.getCurrentStock("Google") +
          nvidiaStock *
          stocks.getCurrentStock("Nvidia") +
          cokeStock *
          stocks.getCurrentStock("Coke-Cola") +
          bankAccount
        )
      );
    }
